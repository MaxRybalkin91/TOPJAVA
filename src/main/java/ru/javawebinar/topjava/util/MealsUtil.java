...
public class MealsUtil {
    public static final List<Meal> MEALS_1 = Arrays.asList(
            new Meal(LocalDateTime.of(2015, Month.MAY, 10, 10, 0), "Завтрак", 600),
            new Meal(LocalDateTime.of(2015, Month.MAY, 20, 13, 0), "Обед", 800),
            new Meal(LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Ужин", 600)
    );

    public static final List<Meal> MEALS_2 = Arrays.asList(
            new Meal(LocalDateTime.of(2015, Month.JUNE, 30, 10, 0), "Breakfast", 700),
            new Meal(LocalDateTime.of(2015, Month.JULY, 30, 13, 0), "Lunch", 1000),
            new Meal(LocalDateTime.of(2015, Month.JULY, 30, 20, 0), "Dinner", 500)
    );
