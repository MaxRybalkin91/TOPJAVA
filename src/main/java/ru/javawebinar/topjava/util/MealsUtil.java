...
public class MealsUtil {
    ...
    public static List<Meal> getExampleList() {
    ...
    public static List<MealTo> convertWithExcess(Collection<Meal> meals) {
        return new ArrayList<>(getFilteredWithExcess(meals, LocalTime.MIN, LocalTime.MAX, MealTo.getCaloriesPerDay()));
    }
